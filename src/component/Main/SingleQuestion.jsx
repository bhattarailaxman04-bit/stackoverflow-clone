// SingleQuestion.jsx (Renamed from Question.jsx in ./component/Main/)
import { useEffect, useState } from "react";
import { useParams } from "react-router-dom";
import mockQuestions from "../../data/mockQuestion"; // Adjust path as needed
...
export default function SingleQuestion() {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4">
            ...
            {/* Body (The Answer/Body of the question is displayed here) */}
